...
export default function BuildPage() {
  const [link, setLink] = React.useState('https://next-ogi.vercel.app/api/general');
  const [imgLink, setImgLink] = React.useState(
    'https://next-ogi.vercel.app/api/general'
  );
  ...
  React.useEffect(() => {
    ...
    const qurl = queryString.stringifyUrl(
      {
        url: `https://next-ogi.vercel.app/api/${ogType}`,
        query: { ...rest },
      },
      {
                ...
                <div className='grid md:grid-cols-[2fr,3fr] gap-8 items-center'>
                  <div className='flex flex-col gap-3 mt-8 md:max-w-sm'>
                    ...
                    <Input
                      id='logo'
                      label='Logo Links'
                      helperText='default: https://next-ogi.vercel.app/images/logo.jpg'
                    />
                    <Input
                      id='banner'
                      label='Banner Links'
